...
$now=(int)time();
$now= (1<<17) & $now;
if($now==0)$chorfb="Chat";
else $chorfb="Feedback";
$t=array();
...
<ul>
	...
	<li$t[7]><a href="exp1/event3.php">Events</a></li>
	<li$t[8]><a href="exp4/shoutbox1.php">$chorfb</a></li>
</ul>
</nav>
EOF;
...
if($p=="formula1")$current2=5;
if($p=="players1")$current2=5;
if($p=="admin1")$current2=2;
if($p=="coadmin1")$current2=3;
if($p=="description")$current2=1;
if($p=="event1")$current2=2;
if($p=="event2")$current2=1;
if($p=="event3")$current2=3;
...
<ul>
	...
	<li$t[5]><a href="exp4/formula1.php">Explanation</a></li>
	<li$t[6]><a href="exp5/players1.php">Player</a></li>
	<li$t[7]><a href="exp5/sstats1.php">Old Seasons</a></li>
</ul>
</nav>
EOF;
}
...
<ul>
	...
	<li$t[5]><a href="exp5/reg1.php">Registrate yourself</a></li>
...
<nav class="nav">
<ul>
	<li$t[1]><a href="exp1/event2.php">THousandTH</a></li>
	<li$t[2]><a href="exp1/event1.php">sp0ck surprise</a></li>
	<li$t[3]><a href="exp3/event3.php">Nelly's birthday</a></li>
</ul>
</nav>
EOF;
}
