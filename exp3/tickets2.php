...
/*
1 - sort by ts2, ts3, ts2 + ts3>0
2 - sort by ts3, ts2, ts2 + ts3>0
3 - sort by ts3, ts2, ts3>0
4 - sort by alphabet , ts2, ts3, ts2+ts3>0
restructure?
invent some for step4 ?
*/
$sort1  = (array_key_exists("sort", $_GET) && isset($_GET['sort']) && is_numeric($_GET['sort']) && $_GET['sort'] > 0) ? $_GET['sort'] : 0;
$sort2  = 1;
if ((int) $sort1 < 5 and (int) $sort1 > 0)
  $sort2 = (int) $sort1;
$ssortt .= array("","2","3","3")[$sort2] . "</b>";
if ($sort2 == 4)
...
<?php
if ($sort2 != 3)
  print "<th><a href=\"/{$url}?sort=2{$sa2}\">Step 3</a></th>";
else
  print "<th><a href=\"/{$url}?sort=3{$sa2}\">Step 3</a></th>";
?>
<th>Step 4</th>
</tr>
<?
